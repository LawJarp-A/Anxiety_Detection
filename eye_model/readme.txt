...
or
refer to https://www.pyimagesearch.com/2017/03/27/how-to-install-dlib/
...
3)The pupil is extracted using contours and the center is found out using cenroid method of that contour
i.e.
Cx=M10/M00
Cy=M01/M00
...
Synopsis fro Anxiety Score:A score between 0 to 1 is assigned based on the following:-
...
4.Changes in position of the eye in measured every frame. Scores are assigned as following:
                 0-70 times per minute                    0 to 0.2 
                 70-100 times per minute                 0.4 to 0.6        
                 100-150 times per minute                0.7 to 0.9                
